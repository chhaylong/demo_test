...
void printstudentlist(List*student){
    node*temp=student->head;
    while(temp!=0){
        cout<<"ID: "<<temp->ID<<" Name: "<<temp->name<<" Year: "<<temp->year<<" Program_degree: "<<temp->program_degree<<endl;
        temp=temp->next;
    }
}
int main(){
    ...
    insertstudent(student,5,"bros makara",2,"GCI");
    cout<<"First display: "<<endl;
    printstudentlist(student);
    cout<<endl<<endl;
    insertstudent(student,6,"bros leang",2,"GCI");
    insertstudent(student,7,"bros ka",2,"GEE");
